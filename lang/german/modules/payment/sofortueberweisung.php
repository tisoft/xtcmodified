 ...
 */
  ...
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STATUS_DESC', 'Bezahlung per Vorkasse mit integrierter Sofort&uuml;berweisung acceptieren?');
  ...
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STORE_TRANSACTION_DETAILS_DESC', 'Transactionsdetails bei Benachrichtigung in das Kommentarfeld speichern (zum debuggen, ist f&uuml;r Kunden via Konto sichtbar)');
 ...
 // {{customer_email}} Email des Kunden
  ...
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_EMAIL_FOOTER', "Sollten Sie den Betrag nicht via Sofort&uuml;berweisung bezahlt haben, bitten wir Sie den Betrag an:\n KntNr. 12345\n BLZ 1234\n zu &uuml;berweisen.  \n\nAdressat:\n" . STORE_NAME_ADDRESS . "\n\n" . 'Ihre Bestellung wird nicht versandt, bis wir das Geld erhalten haben!');
