...
define('TEXT_INFO_CUSTOMERS_STATUS_BT_PERMISSION_INTRO', '<strong>M&ouml;chten Sie erlauben, daﬂ diese Kundengruppe per Bankeinzug bezahlen darf?</strong>');
define('TEXT_INFO_CUSTOMERS_STATUS_CC_PERMISSION_INTRO', '<strong>M&ouml;chten Sie erlauben, daﬂ diese Kundengruppe per Kreditkarte bezahlen darf?</strong>');
define('TEXT_INFO_CUSTOMERS_STATUS_COD_PERMISSION_INTRO', '<strong>M&ouml;chten Sie erlauben, daﬂ diese Kundengruppe per Nachnahme bezahlen darf?</strong>');
...
define('TEXT_INFO_CUSTOMERS_STATUS_BASE', '<strong>Basis Kundengruppe f¸r Artikelpreise</strong>');
