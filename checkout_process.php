...
// BOF - Hendrik - 2010-07-19 - Fixed invalid function call xtc_href_link in checkout_process.php
    //xtc_redirect(xtc_href_link(FILENAME_DEFAULT, '', ''));
	xtc_redirect(xtc_href_link(FILENAME_DEFAULT, '', 'NONSSL'));
// EOF - Hendrik - 2010-07-19 - Fixed invalid function call xtc_href_link in checkout_process.php
}
