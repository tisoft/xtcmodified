...
define('MODULE_GUENSTIGER_TEXT_DESCRIPTION', '<hr noshade="noshade"><br><center><a href="http://www.guenstiger.de/"><img src="http://www.guenstiger.de/bilder/logo_index4top.gif" border="0" alt="Guenstiger - Ihr Preisvergleich"></a></center><br><br>
<b>Export</b><br>Guenstiger.de<br><br>
<b>Trennzeichen</b><br>getrennt durch | (PIPE)<br><br>
<b>Format</b><br>- ProduktID<br>- Gewicht<br>- EAN<br>- Hersteller<br>- ProduktBezeichnung<br>- ArtikelNr. (ggf. auch Hersteller-ArtikelNr.)<br>- Preis<br>- Produktbeschreibung (kurz)<br>- Produktbeschreibung (lang)<br>- Lieferzeit<br>- Produktlink<br>- FotoLink<br>- Kategoriename<br><br>
<b>Modulversion</b><br>guenstiger.de - <i>August 2008 - 1.2 - 29.08.2008</i><br><br>
<b>Fragen</b><br>HSID Verlagsgesellschaft mbH<br>Vorsetzen 53<br>20459 Hamburg-Hafen<br><br>Tel: +49 40 31 97 96 0<br>Fax: +49 40 31 97 96 99<br>E-Mail:<a href="mailto:kontakt@guenstiger.de?SUBJECT=Fragen zum XT:Commerce-Modul 0.7.7"><u>kontakt@guenstiger.de</u></a>');
define('MODULE_GUENSTIGER_TEXT_TITLE', 'Guenstiger.de - CSV');
define('MODULE_GUENSTIGER_FILE_TITLE' , '<hr noshade>Dateiname');
define('MODULE_GUENSTIGER_FILE_DESC' , 'Geben Sie einen Dateinamen ein, falls die Exportadatei am Server gespeichert werden soll.<br>(Verzeichnis export/)');
define('MODULE_GUENSTIGER_STATUS_DESC','Modulstatus');
define('MODULE_GUENSTIGER_STATUS_TITLE','Status');
define('MODULE_GUENSTIGER_CURRENCY_TITLE','W&auml;hrung');
define('MODULE_GUENSTIGER_CURRENCY_DESC','Welche W&auml;hrung soll exportiert werden?');
...
// include needed functions
  ...
  class guenstiger{
    ...
    return array('text' =>  EXPORT_STATUS_TYPE.'<br>'.
                            ...
                            xtc_button_link(BUTTON_CANCEL, xtc_href_link(FILENAME_MODULE_EXPORT, 'set=' . $_GET['set'] . '&module=guenstiger')));
    ...
    function install() {
      xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, set_function, date_added) values ('MODULE_GUENSTIGER_FILE', 'guenstiger.csv',  '6', '1', '', now())");
