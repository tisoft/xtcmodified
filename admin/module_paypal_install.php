...
function progdat02($wasn,$lang=''){
	...
	switch($wasn){
		...
		case 3: // im Shop (root)
			...
			'checkout_process.php'=>array('1','is_array($_SESSION[\'nvpReqArray\']','xtc_href_link(FILENAME_PAYPAL_CHECKOUT','paypalexpress','xtc_href_link(FILENAME_PAYPAL_CHECKOUT','paypalexpress','xtc_href_link(FILENAME_PAYPAL_CHECKOUT','paypalexpress','xtc_href_link(FILENAME_PAYPAL_CHECKOUT','($$_SESSION[\'payment\']->tmpOrders == true)','$attributes_query','$attributes_query','isset($_SESSION[\'reshash\'][\'ACK\']','$o_paypal->EXPRESS_CANCEL_URL','$_SESSION[\'reshash\'][\'REDIRECTREQUIRED\']','unset($_SESSION[\'payment\'])'),
...
function progdat01($wasn,$lang=''){
	...
	switch($wasn){
		...
		case 3: // im /admin/includes/modules
			...
			break;
		case 4: // im shop root
			return array('paypal_checkout.php'=>400919818);
			break;
		...
		case 7: // im shop root/includes/classes/
			return array('paypal_checkout.php'=>959959190);
			break;
		case 8: // im shop root/includes/modules/payment/
			return array(
			'paypal.php'=>4159550416,
			'paypalexpress.php'=>3128619644
			);
			break;
		case 9: // Shop Programme /lang
			return array(
			'admin/paypal.php'=>(($lang=='german')?2107463942:(($lang=='english')?3053301568:0)),
			'modules/payment/paypal.php'=>(($lang=='german')?3829199261:(($lang=='english')?2523515923:0)),
