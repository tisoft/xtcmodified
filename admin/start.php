...
<?php
	...
	// customers drop down
		...
		} elseif  (isset($HTTP_GET['customers_id']) && ($HTTP_GET['customers_id'] > 0)) {
		      $invoice_number = xtc_db_prepare_input($HTTP_GET['customers_id']);
		      $status = xtc_db_prepare_input($HTTP_GET['status']);
...
?>
              <tr>
                <td colspan="5"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="smallText" valign="top"><?php echo $orders_split->display_count($orders_query_numrows, '100', $_GET['page'], TEXT_DISPLAY_NUMBER_OF_ORDERS); ?></td>
                    <td class="smallText" align="right"><?php echo $orders_split->display_links($orders_query_numrows, '100', MAX_DISPLAY_PAGE_LINKS, $_GET['page'], xtc_get_all_get_params(array('page', 'oID', 'action'))); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
