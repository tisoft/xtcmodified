...
$smarty->assign('BUTTON_BUY_NOW', '<a href="'.xtc_href_link(FILENAME_DEFAULT, 'action=buy_now&BUYproducts_id='.$reviews['products_id']).'&'.SEQ_LTOKEN('buy_now').'">'.xtc_image_button('button_in_cart.gif', IMAGE_BUTTON_IN_CART));
