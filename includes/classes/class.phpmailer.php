...
class PHPMailer {
  ...
  function MailSend($header, $body) {
    ...
    $toArr = explode(',', $to); // Dokuman - 2010-02-15 - replaced depricated function split with explode to be ready for PHP >= 5.3
    ...
    if(isset($images[2])) {
      foreach($images[2] as $i => $url) {
        ...
        if (!preg_match('/^[A-z][A-z]*:\/\//',$url)) {
          ...
          $fileParts = explode(".", $filename); // Dokuman - 2010-02-15 - replaced depricated function split with explode to be ready for PHP >= 5.3
          $ext = $fileParts[1];
