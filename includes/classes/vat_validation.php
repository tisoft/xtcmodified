...
class vat_validation {
  ...
  ********************************************************************/
  ...
  function checkVatID_ee($vat_id) {
    ...
    //if ($this->live_check = true) {
     if ($this->live_check) {//Dokuman - 2011-02-07 - correct live-check
  ...
  ********************************************/
  ...
  function checkVatID_nl($vat_id) {
    ...
    if (strtoupper($vat_id[11]) != 'B')
      return 0;
    //BOF - AF - DokuMan - 2011-02-07 - corrected check for NL
    ...
    //EOF - AF - DokuMan - 2011-02-07 - corrected check for NL
    return 1;
  } // end niederlande
  ...
  ********************************************************************/
  ...
  function live($abfrage_nummer) {
    ...
    $ch = curl_init("http://wddx.bff-online.de/ustid.php?".$ustid_post."");//Dokuman - 2011-02-07 - corrected URL
